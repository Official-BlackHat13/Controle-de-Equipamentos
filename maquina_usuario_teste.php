			...
			<div class="col-md-2">
				<form autocomplete="off" >
				  <div class="autocomplete" style="width:200px;">
					<input class="form-control" id="hostname" type="text" name="hostname" placeholder="Hostname ou IMEI" onkeyup="maiuscula(this);filtrar(this.value);">
					<input type="hidden" id="chave" name="chave" value="" />
					<span id="search_result"></span>
				  </div>
				</form>
				<!--
				<input type="text" class="form-control" id="hostname" value="" onkeyup="maiuscula(this);" placeholder="Digite o hostname" />
				-->
			</div>
