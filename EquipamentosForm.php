			...
			<div class="row justify-content-around align-self-center">	
				<div class="form-group col-md-4">
				  ...
				  <?php 
					...
					$sqlMat = mysqli_query($con,"SELECT codigo, patrimonio, tipo, hostname FROM equipamentos.equipamentos where tipo = '".$tipo."' order by tipo asc")or die(mysqli_error($con));
					while($resMat = mysqli_fetch_array($sqlMat)){
						echo "<option value='".$resMat['patrimonio']."'>".$resMat['patrimonio']." - ".$resMat['hostname']."</option>";
					}
...
?>
		<div class="col-md-12">
			...
			<div class="row justify-content-around align-self-center">
				...
				<div class="form-group col-md-4">
				  <label class="label" for="flags"><b>Compartilhado:</b></label>
				   &emsp;
				  <input type="checkbox" class="flags" id="flag" >
				</div>
			</div><br>
...
/*
		<label class="label" for="valor"><b>Maquina:</b> </label>
					
					
					<select class="form-control" id="">
						<option value=""> -- Selecione a Maquina -- </option>
						<?php 
							$sqlMat = mysqli_query($con,"SELECT codigo, patrimonio, tipo FROM equipamentos.equipamentos where tipo in ('DESKTOP','NOTEBOOK') order by tipo asc")or die(mysqli_error($con));
							while($resMat = mysqli_fetch_array($sqlMat)){
								echo "<option value='".$resMat['patrimonio']."'>".$resMat['patrimonio']." - ".utf8_encode($resMat['tipo'])."</option>";
							}
						?>
